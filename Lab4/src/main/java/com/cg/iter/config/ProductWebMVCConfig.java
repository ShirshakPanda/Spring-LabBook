...
public class ProductWebMVCConfig {
	private static final Logger Log= LoggerFactory.getLogger(ProductWebMVCConfig.class);
	
	@Bean
	public ViewResolver getViewResolver() {
		InternalResourceViewResolver viewResolver=new InternalResourceViewResolver();
		viewResolver.setPrefix("/WEB-INF/awesome/");
		...
		public DataSource oracleDataSource() {
			try {
				...
				dataSource.setPassword("Shirshakpanda31");
				return dataSource;
			} catch (Throwable e) {
